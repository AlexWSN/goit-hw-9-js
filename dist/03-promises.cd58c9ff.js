...
})({"fWQyv":[function(require,module,exports) {
...
form.addEventListener("submit", (event)=>{
    ...
    for(let i = 1; i <= amount; i++){
        ...
        createPromise(i, delay).then(({ position, delay })=>{
            ...
            (0, _notiflixDefault.default).Notify.success(`\u{2705} Fulfilled promise ${position} in ${delay}ms`);
        }).catch(({ position, delay })=>{
            // Mesaj de eroare cu Notiflix
            (0, _notiflixDefault.default).Notify.failure(`\u{274C} Rejected promise ${position} in ${delay}ms`);
        });
    }
});

},{"notiflix":"9TqrZ","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"9TqrZ":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},["fWQyv","8tzFL"], "8tzFL", "parcelRequired7c6")
